 <?php
    ...
    $user_id = $_SESSION['user_id'];
        $sql = "SELECT r.resortID, resortName, address, city, state, resortPhoneNo, overallRatings, pricePerNight, capacity, images FROM resorts r, resort_image i WHERE r.resortID = i.resortID ;";
