...
<html lang = "en">
 ...
 <title>Manage Bookings</title>
    <link rel="stylesheet" href="manageStyle.css">
         ...
         <h1 style="margin-left:45% ;margin-top:50px"   class="">Add Reservation</h1>
         <br><br>
     <div class ="insert-date" style="margin-left: 30%; margin-right: 30%;">
      ...
      <td width="73%">
      <input type="date" name="fdate" class="form-control" id="fdate" required min="<?php echo date("Y-m-d"); ?>">
      </td>
      </tr>
      <tr>
      <th width="27%" height="63" scope="row">To:</th>
      <td width="73%">
      <input type="date" name="tdate" class="form-control" id="tdate" required min="<?php echo date("Y-m-d"); ?>"></td>
      </tr>
